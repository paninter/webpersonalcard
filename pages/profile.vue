            ...
            <div class="profile-feed row">
              <div class="col-sm-6">
                ...
                <div class="profile-activity clearfix">
                  <div>
                    <i
                      class="pull-left thumbicon fa fa-check btn-success no-hover"
                    ></i>
                    <a class="user" href="#"> Alex Doe </a>
                    joined
                ...
                <div class="profile-activity clearfix">
                  <div>
                    <i
                      class="pull-left thumbicon fa fa-picture-o btn-info no-hover"
                    ></i>
                    <a class="user" href="#"> Alex Doe </a>
              ...
              <div class="col-sm-6">
                <div class="profile-activity clearfix">
                  <div>
                    <i
                      class="pull-left thumbicon fa fa-pencil-square-o btn-pink no-hover"
                    ></i>
                    <a class="user" href="#"> Alex Doe </a>
                ...
                <div class="profile-activity clearfix">
                  <div>
                    <i
                      class="pull-left thumbicon fa fa-key btn-info no-hover"
                    ></i>
                    <a class="user" href="#"> Alex Doe </a>
                ...
                <div class="profile-activity clearfix">
                  <div>
                    <i
                      class="pull-left thumbicon fa fa-power-off btn-inverse no-hover"
                    ></i>
                    <a class="user" href="#"> Alex Doe </a>
                ...
                <div class="inline pos-rel">
                  ...
                  <div class="popover">
                    ...
                    <div class="popover-content">
                      ...
                      <div class="time">
                        <i
                          class="ace-icon fa fa-clock-o middle bigger-120 orange"
                        ></i>
                      ...
                      <div class="tools action-buttons">
                        <a href="#">
                          <i
                            class="ace-icon fa fa-facebook-square blue bigger-150"
                          ></i>
                        </a>
                        ...
                        <a href="#">
                          <i
                            class="ace-icon fa fa-google-plus-square red bigger-150"
                          ></i>
                        </a>
                      </div>
                    </div>
                ...
                <div class="inline pos-rel">
                  ...
                  <div class="popover">
                    ...
                    <div class="popover-content">
                      ...
                      <div class="time">
                        <i
                          class="ace-icon fa fa-clock-o middle bigger-120 grey"
                        ></i>
                ...
                <div class="inline pos-rel">
                  ...
                  <div class="popover">
                    ...
                    <div class="popover-content">
                      ...
                      <div class="time">
                        <i
                          class="ace-icon fa fa-clock-o middle bigger-120 red"
                        ></i>
