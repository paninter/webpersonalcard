<template>
  <div>
    <b-modal v-model="show" id="modal-1" title="รายละเอียด">
      ...
      <b-form-group id="input-group-2" label="เบอร์โทร" label-for="input-2">
        <b-form-input v-model="tel" disabled></b-form-input>
      </b-form-group>
      <b-form-group id="input-group-2" label="Facebook" label-for="input-2">
        <b-form-input v-model="facebook" disabled></b-form-input>
      </b-form-group>
      <b-form-group id="input-group-2" label="Line" label-for="input-2">
        <b-form-input v-model="line" disabled></b-form-input>
      </b-form-group>
      <b-form-group id="input-group-2" label="Tiktok" label-for="input-2">
        <b-form-input v-model="tiktok" disabled></b-form-input>
      </b-form-group>
