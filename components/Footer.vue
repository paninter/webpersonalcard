<template>
  <footer class="site-footer">
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-6">
          ...
          <section class="widget widget-light-skin">
            <h3 class="widget-title">ติดต่อกับพวกเรา</h3>
            <p class="text-white">เบอร์โทร:000xxxxx</p>
            <ul class="list-unstyled text-sm text-white">
              <li>
                <span class="opacity-50">จันทร์-เสาร์:</span>9.00 am - 8.00 pm
              </li>
              <li>
                <span class="opacity-50">อาทิตย์:</span>10.00 am - 6.00 pm
              </li>
            </ul>
            <p><a class="navi-link-light" href="#">Girch@hotmail.com</a></p>
        ...
        <div class="col-lg-3 col-md-6">
          <!-- บัญชี -->
          <section class="widget widget-links widget-light-skin">
            <h3 class="widget-title">บัญชี &amp; ข้อมูลการจัดส่ง</h3>
            <ul>
      ...
      <p class="footer-copyright"><a>&copy; Grich</a></p>
    </div>
  </footer>
</template>
